<template>
  <div class="app-container">
    ...
    <el-table :key="tableKey" v-loading="listLoading" :data="list" element-loading-text="Loading" border fit
      ...
      <el-table-column label="操作" width="200" align="center">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="primary" @click="showRoleDialog(scope.row.id)">删除
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog title="用户信息" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        ...
        <el-form-item label="用户头像" :label-width="formLabelWidth">
          <el-upload ref="upload" class="avatar-uploader" :action="'/ssm/user/upload'" :show-file-list="false"
